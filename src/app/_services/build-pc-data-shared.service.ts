...
export class BuildPcDataSharedService {
  ...
  private deselectPcPartByCategory = new Subject<PcBuildCategory>();
  ...
  updateDeselectPcPartByCategory(pcBuildCategory: PcBuildCategory){
    this.deselectPcPartByCategory.next(pcBuildCategory);
  }
